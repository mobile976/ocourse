...
# Example: ALLOWED_HOSTS=.onrender.com,localhost,127.0.0.1
...
# Database
# Always use PostgreSQL via DATABASE_URL (both local and Render).
# .env (local) → External Database URL
# Render Environment → Internal Database URL
...
# WhiteNoise-д зориулсан storage
